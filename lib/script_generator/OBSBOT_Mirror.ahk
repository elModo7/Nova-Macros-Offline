...
Gui Add, Radio, x8 y8 w191 h48  checked venabled, Enable Mirror
Gui Add, Radio, x8 y64 w191 h48 vdisabled, Disable Mirror

Gui Show, w213 h126, OBSBOT Set Mirror
Return

#If WinActive("OBSBOT Set Mirror")
