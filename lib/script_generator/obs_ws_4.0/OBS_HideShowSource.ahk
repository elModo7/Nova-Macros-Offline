...
Gui Add, Radio, x32 y40 w120 h23 vshow checked, Show Source
Gui Add, Radio, x160 y40 w120 h23 vhide, Hide Source

Gui Show, w339 h74, Hide / Show Source
return
...
class LlamadaWS extends WebSocket
{
	...
	{
		Sleep, 100
		Data = {""item"": """ source """, ""visible"": " visibility ",""request-type"": ""SetSceneItemProperties"",""message-id"": ""123""}
		this.Send(Data)
	}
