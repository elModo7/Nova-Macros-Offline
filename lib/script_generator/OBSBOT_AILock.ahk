...
Gui Add, Radio, x8 y8 w191 h48 Checked vaiLock, AI Lock
Gui Add, Radio, x8 y64 w191 h48 vaiUnlock, AI Unlock

Gui Show, w207 h120, OBSBOT AI Lock / Unlock
Return

#If WinActive("OBSBOT AI Lock / Unlock")
...
generateScript:
	GuiControlGet, aiLock,, aiLock
	GuiControlGet, aiUnlock,, aiUnlock
	if(aiLock){
		value := 1
	}else if(aiUnlock){
		value := 0
